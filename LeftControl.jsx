...
function LeftControl() {
    return (
        <div className="w-[80px] h-[240px] border-4 border-solid  relative">
            ...
            <div className="absolute top-5 left-1/2 -translate-x-1/2 w-10 h-10 border-4 rounded-full"></div>

            { <div className="absolute top-20 left-1/2 -translate-x-1/2 w-14 h-14 relative">
